...
//---------------------------------------------------------------------------
#define   _IQabs(A)    (((A) >= 0.0) ? (A) : -(A))
#define   _IQ30abs(A)  _IQabs(A)
#define   _IQ29abs(A)  _IQabs(A)
#define   _IQ28abs(A)  _IQabs(A)
#define   _IQ27abs(A)  _IQabs(A)
#define   _IQ26abs(A)  _IQabs(A)
#define   _IQ25abs(A)  _IQabs(A)
#define   _IQ24abs(A)  _IQabs(A)
#define   _IQ23abs(A)  _IQabs(A)
#define   _IQ22abs(A)  _IQabs(A)
#define   _IQ21abs(A)  _IQabs(A)
#define   _IQ20abs(A)  _IQabs(A)
#define   _IQ19abs(A)  _IQabs(A)
#define   _IQ18abs(A)  _IQabs(A)
#define   _IQ17abs(A)  _IQabs(A)
#define   _IQ16abs(A)  _IQabs(A)
#define   _IQ15abs(A)  _IQabs(A)
#define   _IQ14abs(A)  _IQabs(A)
#define   _IQ13abs(A)  _IQabs(A)
#define   _IQ12abs(A)  _IQabs(A)
#define   _IQ11abs(A)  _IQabs(A)
#define   _IQ10abs(A)  _IQabs(A)
#define   _IQ9abs(A)   _IQabs(A)
#define   _IQ8abs(A)   _IQabs(A)
#define   _IQ7abs(A)   _IQabs(A)
#define   _IQ6abs(A)   _IQabs(A)
#define   _IQ5abs(A)   _IQabs(A)
#define   _IQ4abs(A)   _IQabs(A)
#define   _IQ3abs(A)   _IQabs(A)
#define   _IQ2abs(A)   _IQabs(A)
#define   _IQ1abs(A)   _IQabs(A)
//###########################################################################
#endif  // No more.
//###########################################################################
